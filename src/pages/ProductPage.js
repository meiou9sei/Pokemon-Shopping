...
export const ProductPage = ({
  ...
  useEffect(() => {
    if (isInventoryLoaded) {
      setIsValidProductId(productId > 0 && productId <= inventoryCount);
    }
    if (isValidProductId) {
  ...
  return (
    <div className='product-page'>
      {(isInventoryLoaded && !isValidProductId && (
        <div className='invalid-product-id'>
          <p>It appears this pokemon doesn't exist!</p>
          <Link to='/store'>Take me back to the store!</Link>
        </div>
      )) ||
        (isProductLoaded && (
          <div className='product-wrapper'>
            ...
            <div className='product-info'>
              ...
              <div className='product-description'>
                <p className='product-generation'>
                  {productDetails.generation}
                </p>
